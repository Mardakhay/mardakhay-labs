      ...
      <div className='w-full max-w-md rounded-3xl border border-white/10 bg-zinc-950 p-6 shadow-2xl'>
        ...
        <div className='mt-6 flex items-center justify-end gap-3'>
          <button
            onClick={onCancel}
            disabled={isLoading}
            className='rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm font-medium text-zinc-300 transition-colors hover:border-zinc-500 hover:text-white disabled:cursor-not-allowed disabled:opacity-50'
          >
            {cancelLabel}
          </button>
