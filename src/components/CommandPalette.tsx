...
function CommandPalette({
  ...
  return (
    <div className='app-modal-backdrop fixed inset-0 z-[80] flex items-start justify-center bg-black/65 px-3 pt-20 backdrop-blur-sm sm:pt-28'>
            ...
            filteredItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className='flex min-h-14 w-full items-center gap-3 rounded-2xl px-3 text-left transition-colors hover:bg-white/[0.04]'
                >
